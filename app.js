...
function App(){
  ...
  return CE('div',{className:'app-shell'},
      ...
      CE('div',{className:'app-topbar'},
        ...
        CE('div',{className:'app-topbar-right'},
          ...
          loading&&CE('span',{style:{fontSize:11,color:'var(--text-muted)',display:'flex',alignItems:'center',gap:4}},
            CE('span',{className:'spinner',style:{borderTopColor:'var(--accent)',borderColor:'var(--border)'}}), 'Chargement…'),
    ...
    // ── Theme picker via portail — échappe tous les stacking contexts ──
    showThemePicker&&ReactDOM.createPortal(
      CE(React.Fragment,null,
        CE('div',{className:'theme-picker-overlay',onClick:()=>setShowThemePicker(false)}),
        CE('div',{className:'theme-picker'},
