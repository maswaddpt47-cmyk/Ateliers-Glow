...
(function injectCSS(){
  ...
  s.textContent=`
/* ══ THÈME GDIN — Dark Navy Cyan ══ */
[data-theme="gdin"]{
  --bg:#0a0f1a;--card-bg:#0d1420;--surface:#0f1a2b;--surface-2:#111c2b;--surface-alt:#090d16;--pbi-bar:#060a12;
  --text:#e2e8f0;--text-2:#7a9abf;--text-3:#4a6080;--text-muted:#2d4a6b;
  --border:#1e2d40;--border-light:#141e2e;--border-pbi:#1a2838;
  --accent:#00d4ff;--accent-hover:#00b8e0;--accent-bg:#001a24;--accent-2:#00d4ff;
  --glow:0 0 14px #00d4ff66,0 0 28px #00d4ff33;
  --glow-sm:0 0 8px #00d4ff44;
  --glow-card:0 1px 6px rgba(0,0,0,.5),0 0 0 1px #1e2d40,0 0 8px #00d4ff18;
...
[data-theme="grafana"]{
  --bg:#111217;--card-bg:#181b1f;--surface:#1e2024;--surface-2:#23252e;--surface-alt:#0e0f12;--pbi-bar:#0a0b0e;
  --text:#d9d9d9;--text-2:#9ca3af;--text-3:#6b7280;--text-muted:#4b5563;
  --border:#2c2f36;--border-light:#1e2024;--border-pbi:#2c2f36;
  --accent:#ff9800;--accent-hover:#e68900;--accent-bg:#1a0f00;--accent-2:#ff9800;
  --glow:0 0 14px #ff980055,0 0 28px #ff980022;
  --glow-sm:0 0 8px #ff980044;
  --glow-card:0 1px 4px rgba(0,0,0,.4),0 0 0 1px #2c2f36;
...
[data-theme="glass"]{
  --bg:#0b0518;--card-bg:rgba(255,255,255,0.05);--surface:rgba(255,255,255,0.04);--surface-2:rgba(255,255,255,0.06);--surface-alt:rgba(255,255,255,0.02);--pbi-bar:#070312;
  --text:#f0e6ff;--text-2:rgba(240,230,255,0.55);--text-3:rgba(240,230,255,0.35);--text-muted:rgba(240,230,255,0.2);
  --border:rgba(255,255,255,0.1);--border-light:rgba(255,255,255,0.06);--border-pbi:rgba(255,255,255,0.08);
  --accent:#e879f9;--accent-hover:#d946ef;--accent-bg:rgba(232,121,249,0.12);--accent-2:#e879f9;
  --glow:0 0 20px rgba(232,121,249,0.35),0 0 40px rgba(168,85,247,0.2);
  --glow-sm:0 0 12px rgba(232,121,249,0.25);
  --glow-card:0 4px 24px rgba(0,0,0,0.4),inset 0 1px 0 rgba(255,255,255,0.08);
...
[data-theme="cyber"]{
  --bg:#050509;--card-bg:#08050f;--surface:#0a0812;--surface-2:#0f0c18;--surface-alt:#040308;--pbi-bar:#030207;
  --text:#c4b5fd;--text-2:#7c5cbf;--text-3:#4c2d8a;--text-muted:#2d1a5e;
  --border:#2d1a5e;--border-light:#1f1140;--border-pbi:#3d2070;
  --accent:#7c3aed;--accent-hover:#6d28d9;--accent-bg:#1a0a3a;--accent-2:#a78bfa;
  --glow:0 0 16px #7c3aed88,0 0 32px #7c3aed44;
  --glow-sm:0 0 8px #7c3aed66;
  --glow-card:0 1px 6px rgba(0,0,0,.6),0 0 0 1px #2d1a5e,0 0 10px #7c3aed22;
...
[data-theme="light"]{
  ...
  --font-ui:'Segoe UI',sans-serif;--panel-bg:#ffffff;--panel-header:#f8fafc;
}
...
:root{
  ...
  --text:#e2e8f0;--text-2:#94a3b8;--text-3:#64748b;--text-muted:#475569;
  --border:#1e2a45;--border-light:#141e30;--border-pbi:#1f2d47;
  --accent:#7c3aed;--accent-hover:#6d28d9;--accent-bg:#1a1040;--accent-2:#a78bfa;
  --glow:0 0 12px #7c3aed88,0 0 24px #7c3aed44;--glow-sm:0 0 6px #7c3aed55;
  --glow-card:0 1px 4px rgba(0,0,0,.5),0 0 0 1px #1e2a45,0 0 6px #7c3aed55;
  --skeleton-from:#111827;--skeleton-to:#1e2a45;
  --input-bg:#0d1520;--input-bg-alt:#0f1c2e;--input-border:#1e2a45;
  --offline-bg:#1a0a0a;--offline-border:#7f1d1d;--offline-text:#fca5a5;
  --font-ui:'DM Sans',sans-serif;
}
/* ══ VARIABLES DARK (défaut néon violet) — OBSOLÈTE gardé pour compat ══ */
:root{
  --bg:#0a0e1a;--card-bg:#111827;--surface:#0f1623;--surface-2:#161d2e;--surface-alt:#0d1520;--pbi-bar:#070a12;
  --text:#e2e8f0;--text-2:#94a3b8;--text-3:#64748b;--text-muted:#475569;
  --border:#1e2a45;--border-light:#141e30;--border-pbi:#1f2d47;
  --accent:#7c3aed;--accent-hover:#6d28d9;--accent-bg:#1a1040;--accent-2:#a78bfa;
  --glow:0 0 12px #7c3aed88,0 0 24px #7c3aed44;
  --glow-sm:0 0 6px #7c3aed55;
  --glow-card:0 1px 4px rgba(0,0,0,.5),0 0 0 1px #1e2a45,0 0 6px #7c3aed55;
  --skeleton-from:#111827;--skeleton-to:#1e2a45;
  --input-bg:#0d1520;--input-bg-alt:#0f1c2e;--input-border:#1e2a45;
  --offline-bg:#1a0a0a;--offline-border:#7f1d1d;--offline-text:#fca5a5;
...
.light-mode{
  ...
  --border:#e2e8f0;--border-light:#f0f4f8;--border-pbi:#e5e7eb;
  --accent:#1e3a8a;--accent-hover:#1e40af;--accent-bg:#eff6ff;--accent-2:#2563eb;
  --glow:none;--glow-sm:none;--glow-card:0 1px 4px rgba(0,0,0,.08);
  --skeleton-from:#f0f4f8;--skeleton-to:#e2eaf2;
  --input-bg:#ffffff;--input-bg-alt:#f8fafc;--input-border:#e2e8f0;
  --offline-bg:#fff5f5;--offline-border:#feb2b2;--offline-text:#c53030;
}
*{box-sizing:border-box;margin:0;padding:0}
body{font-family:'Segoe UI',sans-serif;background:var(--bg);color:var(--text);font-size:14px;transition:background .3s,color .3s}
...
.card{background:var(--card-bg);border-radius:10px;padding:20px;box-shadow:var(--glow-card);margin-bottom:16px;border:1px solid var(--border);transition:background .3s,box-shadow .3s}
.card h2{font-size:16px;font-weight:600;color:var(--accent-2);margin-bottom:16px;padding-bottom:10px;border-bottom:2px solid var(--border)}
label{display:block;font-size:12px;font-weight:600;color:var(--text-2);margin-bottom:4px;margin-top:12px}
input,select,textarea{width:100%;padding:8px 10px;border:1.5px solid var(--input-border);border-radius:6px;font-size:13px;color:var(--text);background:var(--input-bg);transition:border .2s,background .2s,color .2s}
...
.btn-primary{background:var(--accent);color:#fff}.btn-primary:hover{background:var(--accent-hover);box-shadow:var(--glow-sm)}
.btn-secondary{background:var(--surface-2);color:var(--text-2);border:1px solid var(--border)}.btn-secondary:hover{background:var(--surface)}
...
.badge-realise{background:#14532d;color:#86efac}
.badge-planifie{background:#1e3a5f;color:#93c5fd}
.badge-annule{background:#450a0a;color:#fca5a5}
.badge-reporte{background:#451a03;color:#fcd34d}
.badge-nonrealise{background:var(--surface-2);color:var(--text-2)}
table{width:100%;border-collapse:collapse;font-size:13px}
th{background:var(--surface);padding:8px 10px;text-align:left;font-weight:600;color:var(--text-2);border-bottom:2px solid var(--border);white-space:nowrap;cursor:pointer;user-select:none}
th:hover{background:var(--surface-2)}
td{padding:8px 10px;border-bottom:1px solid var(--border-light);vertical-align:middle;color:var(--text)}
...
.kpi{background:var(--card-bg);border-radius:10px;padding:16px 20px;box-shadow:var(--glow-card);text-align:center;border:1px solid var(--border)}
.kpi .val{font-size:32px;font-weight:700;color:var(--accent-2)}
.kpi .lbl{font-size:12px;color:var(--text-3);margin-top:4px}
#map-container{height:480px;border-radius:8px;overflow:hidden}
.toast{position:fixed;bottom:24px;right:24px;padding:12px 20px;border-radius:8px;font-weight:600;font-size:13px;z-index:9999;box-shadow:0 4px 12px rgba(0,0,0,.3);transition:opacity .3s}
.toast-ok{background:#166534;color:#fff;border:1px solid #16a34a}
.toast-err{background:#7f1d1d;color:#fff;border:1px solid #dc2626}
...
.loading-full{display:flex;flex-direction:column;align-items:center;justify-content:center;height:300px;color:var(--text-3);gap:12px}
.loading-full .big-spin{width:40px;height:40px;border:4px solid var(--border);border-top-color:var(--accent);border-radius:50%;animation:spin .8s linear infinite}
.mat-checks{display:flex;flex-wrap:wrap;gap:8px;margin-top:6px}
.mat-checks label{display:flex;align-items:center;gap:4px;font-size:12px;font-weight:400;color:var(--text-2);margin-top:0;cursor:pointer}
.mat-checks input{width:auto}
.pagination{display:flex;align-items:center;gap:8px;margin-top:12px;justify-content:flex-end}
.pagination button{padding:4px 10px;border:1.5px solid var(--border);border-radius:4px;background:var(--card-bg);color:var(--text);cursor:pointer;font-size:12px}
.pagination button:disabled{opacity:.4;cursor:default}
.pagination span{font-size:12px;color:var(--text-3)}
.error-box{background:#1a0a0a;border:1.5px solid #7f1d1d;border-radius:8px;padding:16px;color:#fca5a5;display:flex;flex-direction:column;gap:10px;align-items:flex-start}
.admin-section{border:2px solid #3d1515;border-radius:10px;padding:20px;margin-bottom:16px;background:var(--card-bg)}
.admin-section h3{font-size:15px;font-weight:700;color:#f87171;margin-bottom:12px;display:flex;align-items:center;gap:8px}
.confirm-box{background:#1a0a0a;border:1.5px solid #7f1d1d;border-radius:8px;padding:14px;margin-top:12px}
.confirm-box p{font-size:13px;color:#fca5a5;margin-bottom:10px}
.login-wrap{display:flex;align-items:center;justify-content:center;min-height:calc(100vh - 52px)}
.login-card{background:var(--card-bg);border-radius:12px;padding:36px 40px;box-shadow:var(--glow-card);width:340px;text-align:center;border:1px solid var(--border)}
.login-card h2{color:var(--accent-2);margin-bottom:24px;font-size:20px}
...
.log-ok{background:#052e16;border-left:3px solid #16a34a}
.log-err{background:#1a0a0a;border-left:3px solid #dc2626}
.log-info{background:#0c1a2e;border-left:3px solid #3b82f6}
.log-time{color:var(--text-muted);white-space:nowrap}
.progress-bar{height:8px;background:var(--surface-2);border-radius:4px;overflow:hidden;margin-top:8px}
.progress-fill{height:100%;background:var(--accent);border-radius:4px;transition:width .3s;box-shadow:var(--glow-sm)}
.listes-overlay{position:fixed;inset:0;background:rgba(0,0,0,.7);z-index:800;display:flex;align-items:center;justify-content:center;padding:16px}
.listes-modal{background:var(--card-bg);border-radius:14px;width:580px;max-width:100%;max-height:90vh;display:flex;flex-direction:column;box-shadow:0 20px 60px rgba(0,0,0,.5),var(--glow-sm);overflow:hidden;border:1px solid var(--border)}
.listes-header{background:var(--accent);color:#fff;padding:18px 22px 14px;flex-shrink:0;position:relative}
...
.listes-tabs{display:flex;border-bottom:2px solid var(--border);padding:0 22px;background:var(--surface);flex-shrink:0;overflow-x:auto}
.listes-tab{padding:10px 14px;font-size:13px;font-weight:600;color:var(--text-3);cursor:pointer;border-bottom:2px solid transparent;margin-bottom:-2px;white-space:nowrap;transition:all .15s}
.listes-tab:hover{color:var(--accent-2)}
.listes-tab.active{color:#fff;background:var(--accent);border-bottom-color:var(--accent);border-radius:6px 6px 0 0}
.listes-tab .tab-count{display:inline-block;background:var(--surface-2);color:var(--text-2);font-size:10px;font-weight:700;padding:1px 5px;border-radius:10px;margin-left:5px}
.listes-tab.active .tab-count{background:rgba(255,255,255,.25);color:#fff}
.listes-body{flex:1;overflow-y:auto;padding:16px 22px}
.listes-item{display:flex;align-items:center;gap:10px;padding:9px 12px;border-radius:8px;border:1px solid var(--border);margin-bottom:7px;background:var(--surface);transition:box-shadow .15s}
.listes-item:hover{box-shadow:var(--glow-sm)}
.listes-arrows{display:flex;flex-direction:column;gap:2px;flex-shrink:0}
.listes-arrows button{background:none;border:1px solid var(--border);border-radius:3px;width:18px;height:14px;cursor:pointer;font-size:9px;color:var(--text-3);display:flex;align-items:center;justify-content:center;padding:0;transition:all .1s;line-height:1}
.listes-arrows button:hover:not(:disabled){background:var(--accent-bg);color:var(--accent-2)}
.listes-arrows button:disabled{opacity:.3;cursor:default}
.listes-dot{width:10px;height:10px;border-radius:50%;flex-shrink:0}
.listes-name{flex:1;font-size:13px;font-weight:500;color:var(--text)}
.listes-name input{border:1.5px solid var(--accent);border-radius:5px;padding:3px 7px;font-size:13px;width:100%;outline:none;background:var(--input-bg);color:var(--text)}
.listes-actions{display:flex;gap:5px;flex-shrink:0}
.listes-add-row{display:flex;gap:8px;margin-top:14px}
.listes-add-row input{flex:1;padding:8px 12px;border:1.5px solid var(--border);border-radius:7px;font-size:13px;outline:none;transition:border .2s;background:var(--input-bg);color:var(--text)}
.listes-add-row input:focus{border-color:var(--accent)}
.listes-footer{padding:14px 22px;border-top:1px solid var(--border);display:flex;justify-content:flex-end;gap:10px;background:var(--surface);flex-shrink:0}
.combo-wrap{position:relative}
.combo-dropdown{position:absolute;top:100%;left:0;right:0;background:var(--card-bg);border:1.5px solid var(--accent);border-top:none;border-radius:0 0 6px 6px;max-height:240px;overflow-y:auto;z-index:200;box-shadow:0 4px 12px rgba(0,0,0,.3),var(--glow-sm)}
.combo-item{display:flex;align-items:center;gap:10px;padding:7px 12px;cursor:pointer;font-size:13px;transition:background .1s;color:var(--text)}
.combo-item:hover,.combo-item.active{background:var(--accent-bg)}
.combo-cp{font-size:11px;font-weight:700;color:var(--accent-2);min-width:42px;font-family:monospace}
.combo-nom{color:var(--text)}
.combo-empty{padding:10px 12px;color:var(--text-3);font-size:12px;font-style:italic}
.combo-loading{padding:10px 12px;color:var(--accent-2);font-size:12px;display:flex;align-items:center;gap:8px}
.bingo-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:14px;margin-bottom:20px}
.bingo-card{background:var(--card-bg);border-radius:14px;box-shadow:var(--glow-card);padding:16px 12px;text-align:center;cursor:pointer;transition:all .25s;border:2px solid var(--border)}
.bingo-card:hover{box-shadow:var(--glow);transform:translateY(-3px)}
.bingo-card.selected{border-color:var(--accent);box-shadow:var(--glow)}
...
.bingo-nom{font-size:11px;font-weight:700;color:var(--text);margin-bottom:4px;line-height:1.2}
.bingo-pct{font-size:12px;font-weight:700}
.bingo-list{margin-top:16px}
.bingo-list-item{display:flex;align-items:center;gap:10px;padding:8px 12px;border-bottom:1px solid var(--border-light);font-size:13px}
.bingo-list-item:last-child{border-bottom:none}
.bingo-dot{width:8px;height:8px;border-radius:50%;flex-shrink:0}
.bingo-list-date{color:var(--text-3);font-size:12px;min-width:80px}
...
.btn-print{background:var(--surface);color:var(--text-2);border:1.5px solid var(--border)}.btn-print:hover{background:var(--surface-2)}
.badge-retard{background:#450a0a;color:#fca5a5;border:1px solid #7f1d1d;animation:blink-retard 1.4s ease-in-out infinite}
.atelier-card{background:var(--card-bg);border-radius:12px;box-shadow:var(--glow-card);margin-bottom:10px;display:flex;overflow:hidden;transition:box-shadow .2s;cursor:pointer;border:1px solid var(--border)}
.atelier-card:hover{box-shadow:var(--glow)}
.atelier-card-border{width:5px;flex-shrink:0}
.atelier-card-date{width:64px;flex-shrink:0;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:14px 8px;background:var(--surface);border-right:1px solid var(--border)}
.atelier-card-day{font-size:26px;font-weight:800;color:var(--text);line-height:1}
.atelier-card-month{font-size:11px;font-weight:700;color:var(--text-3);text-transform:uppercase;letter-spacing:.05em}
.atelier-card-time{font-size:12px;color:var(--text-2);margin-top:4px;font-weight:600}
.atelier-card-jour{font-size:10px;font-weight:700;color:var(--text-3);text-transform:uppercase;letter-spacing:.05em;margin-top:2px}
...
.atelier-card-title{font-size:14px;font-weight:700;color:var(--text);line-height:1.3;margin-bottom:4px}
.atelier-card-sub{font-size:12px;color:var(--text-3)}
.atelier-card-arrow{display:flex;align-items:center;padding:0 10px;color:var(--border);font-size:18px}
.badge-pill{display:inline-block;padding:2px 9px;border-radius:20px;font-size:11px;font-weight:600}
.bp-planifie{background:#1e3a5f;color:#93c5fd}
.bp-realise{background:#14532d;color:#86efac}
.bp-annule{background:#450a0a;color:#fca5a5}
.bp-reporte{background:#451a03;color:#fcd34d}
.bp-nonrealise{background:var(--surface-2);color:var(--text-3)}
.bp-retard{background:#450a0a;color:#fca5a5;border:1px solid #7f1d1d;animation:blink-retard 1.4s ease-in-out infinite}
.bp-public{background:var(--surface-2);color:var(--text-3)}
.side-panel{position:fixed;top:0;right:0;width:340px;max-width:95vw;height:100vh;background:var(--panel-bg,var(--card-bg));box-shadow:-4px 0 24px rgba(0,0,0,.6),var(--glow-sm);z-index:500;display:flex;flex-direction:column;transform:translateX(100%);transition:transform .25s ease;border-left:1px solid var(--border)}
.side-panel.open{transform:translateX(0)}
.side-panel-header{padding:16px 20px;border-bottom:1px solid var(--border);display:flex;align-items:center;justify-content:space-between;background:var(--panel-header,var(--surface))}
.side-panel-header h3{font-size:14px;font-weight:700;color:var(--text);margin:0}
.side-panel-body{flex:1;overflow-y:auto;padding:16px 20px;background:var(--panel-bg,var(--card-bg))}
.side-panel-footer{padding:12px 20px;border-top:1px solid var(--border);display:flex;gap:6px;flex-wrap:wrap;background:var(--panel-header,var(--surface))}
.side-panel-overlay{position:fixed;inset:0;background:rgba(0,0,0,.5);z-index:499}
.sp-info-row{display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px solid var(--border-light);font-size:13px}
.sp-info-row span:first-child{color:var(--text-3)}
.sp-info-row span:last-child{font-weight:600;color:var(--text);text-align:right;max-width:60%}
.mat-chip{display:inline-block;padding:2px 8px;border-radius:12px;font-size:11px;background:var(--surface-2);color:var(--text-2);margin:2px;border:1px solid var(--border)}
.chip-bar{display:flex;flex-wrap:wrap;gap:6px;margin-bottom:12px}
.chip{display:inline-flex;align-items:center;gap:5px;padding:4px 12px;border-radius:20px;font-size:12px;font-weight:600;border:1.5px solid transparent;cursor:pointer;background:var(--surface);color:var(--text-2);transition:all .15s}
.chip.active{border-color:currentColor;box-shadow:var(--glow-sm)}
.chip-all.active{background:var(--accent-bg);color:var(--accent-2)}
.chip-planifie.active{background:#1e3a5f;color:#93c5fd}
.chip-realise.active{background:#14532d;color:#86efac}
.chip-annule.active{background:#450a0a;color:#fca5a5}
.chip-reporte.active{background:#451a03;color:#fcd34d}
.chip-nonrealise.active{background:var(--surface-2);color:var(--text-3)}
...
.kpi-mini{flex:1;min-width:60px;background:var(--card-bg);border-radius:8px;padding:10px 8px;text-align:center;box-shadow:var(--glow-card);border:1px solid var(--border)}
.kpi-mini .v{font-size:22px;font-weight:800;line-height:1}
.kpi-mini .l{font-size:10px;color:var(--text-3);margin-top:2px}
.kpi-mini .p{font-size:10px;font-weight:600;margin-top:1px}
.sp-field{margin-bottom:14px}
.sp-field label{font-size:11px;font-weight:700;color:var(--text-3);display:block;margin-bottom:4px;text-transform:uppercase;letter-spacing:.05em}
...
.tgl-track{position:absolute;inset:0;background:var(--surface-2);border-radius:24px;cursor:pointer;transition:background .2s;border:1px solid var(--border)}
.tgl-track:before{content:"";position:absolute;top:3px;left:3px;width:18px;height:18px;background:var(--text-muted);border-radius:50%;transition:transform .2s;box-shadow:0 1px 3px rgba(0,0,0,.2)}
.tgl input:checked+.tgl-track{background:var(--accent);box-shadow:var(--glow-sm)}
.tgl input:checked+.tgl-track:before{transform:translateX(20px);background:#fff}
.accueil-wrap{display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:60vh}
.accueil-card{background:var(--card-bg);border-radius:16px;box-shadow:var(--glow);padding:40px 44px;width:100%;max-width:420px;text-align:center;border:1px solid var(--accent)}
.accueil-logo{font-size:48px;margin-bottom:12px}
.accueil-title{font-size:22px;font-weight:800;color:var(--accent-2);margin-bottom:4px}
.accueil-sub{font-size:13px;color:var(--text-3);margin-bottom:28px}
.accueil-label{font-size:12px;font-weight:700;color:var(--text-2);text-align:left;margin-bottom:6px;display:block}
.accueil-select{width:100%;padding:10px 14px;border:2px solid var(--border);border-radius:8px;font-size:14px;color:var(--text);background:var(--input-bg);margin-bottom:20px;cursor:pointer;transition:border .2s}
.accueil-select:focus{outline:none;border-color:var(--accent);box-shadow:var(--glow-sm)}
.accueil-btn{width:100%;padding:12px;background:var(--accent);color:#fff;border:none;border-radius:8px;font-size:15px;font-weight:700;cursor:pointer;transition:all .2s;box-shadow:var(--glow-sm)}
.accueil-btn:hover{background:var(--accent-hover);box-shadow:var(--glow)}
.accueil-btn:disabled{background:var(--surface-2);color:var(--text-muted);cursor:not-allowed;box-shadow:none}
.accueil-skip{margin-top:14px;font-size:12px;color:var(--text-muted);cursor:pointer;text-decoration:underline;background:none;border:none}
.accueil-skip:hover{color:var(--text-2)}
.filtre-banner{background:var(--accent-bg);border:1.5px solid var(--accent);border-radius:8px;padding:9px 14px;display:flex;align-items:center;justify-content:space-between;margin-bottom:12px;font-size:13px;color:var(--accent-2);font-weight:600}
.filtre-banner button{background:var(--accent);color:#fff;border:none;border-radius:6px;padding:4px 12px;font-size:12px;font-weight:600;cursor:pointer}
.filtre-banner button:hover{background:var(--accent-hover)}
/* ── v9.0 : Flux de clôture rapide ── */
.cloture-banner{background:#1a1200;border:1.5px solid #854d0e;border-radius:10px;padding:14px;margin-bottom:16px}
.cloture-title{font-size:12px;font-weight:700;color:#fcd34d;margin-bottom:10px;display:flex;align-items:center;gap:6px;text-transform:uppercase;letter-spacing:.04em}
...
.cloture-btn:hover{filter:brightness(1.15)}
/* ── v9.0 : Badge duplication ── */
.dup-badge{background:var(--accent-bg);border:1.5px solid var(--accent);color:var(--accent-2);font-size:12px;font-weight:600;padding:4px 10px;border-radius:6px;display:inline-flex;align-items:center;gap:5px;margin-bottom:12px}
/* ── v9.1 : Saisie en lot ── */
.mode-toggle{display:flex;gap:0;border:1.5px solid var(--border);border-radius:8px;overflow:hidden;margin-bottom:16px;width:fit-content}
.mode-toggle button{padding:7px 18px;background:var(--card-bg);border:none;cursor:pointer;font-size:13px;font-weight:600;color:var(--text-3);transition:all .15s}
.mode-toggle button.active{background:var(--accent);color:#fff;box-shadow:var(--glow-sm)}
.lot-row{display:grid;grid-template-columns:140px 100px 64px 1fr 32px;gap:8px;align-items:end;padding:10px 12px;border-radius:8px;border:1px solid var(--border);margin-bottom:6px;background:var(--surface)}
.lot-row:hover{background:var(--accent-bg);border-color:var(--accent)}
.lot-row-err{border-color:#7f1d1d !important;background:#1a0a0a !important}
.lot-add-btn{display:flex;align-items:center;justify-content:center;gap:6px;padding:9px;background:var(--surface);border:1.5px dashed var(--accent);border-radius:8px;cursor:pointer;font-size:13px;color:var(--accent-2);font-weight:600;width:100%;transition:all .15s;margin-top:4px;box-sizing:border-box}
.lot-add-btn:hover{background:var(--accent-bg);box-shadow:var(--glow-sm)}
.lot-summary{background:var(--accent-bg);border:1.5px solid var(--accent);border-radius:8px;padding:10px 14px;font-size:13px;color:var(--accent-2);font-weight:600;margin-bottom:12px;display:flex;align-items:center;gap:8px}
.lot-del-btn{background:none;border:1px solid var(--border);border-radius:6px;color:#f87171;cursor:pointer;font-size:15px;height:32px;width:32px;display:flex;align-items:center;justify-content:center;transition:all .15s;flex-shrink:0}
.lot-del-btn:hover{background:#1a0a0a;border-color:#7f1d1d}
/* ── v9.1 : Saisie formulaire redesign ── */
.sf-wrap{padding:4px 0}
.sf-section{background:var(--card-bg);border-radius:14px;padding:18px 20px;margin-bottom:12px;box-shadow:var(--glow-card);border:1px solid var(--border)}
...
.sf-label-gray{font-size:11px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:var(--text-muted);margin-bottom:8px;display:block}
.sf-input{width:100%;padding:11px 14px;border:2px solid var(--input-border);border-radius:10px;font-size:14px;color:var(--text);background:var(--input-bg-alt);transition:all .2s;outline:none}
.sf-input:focus{border-color:var(--ac);background:var(--input-bg);box-shadow:0 0 0 3px var(--ac-light)}
.sf-input.err{border-color:#e53e3e;background:#1a0a0a}
.sf-textarea{width:100%;padding:11px 14px;border:2px solid var(--input-border);border-radius:10px;font-size:14px;color:var(--text);background:var(--input-bg-alt);transition:all .2s;outline:none;resize:vertical;min-height:80px}
.sf-textarea:focus{border-color:var(--ac);background:var(--input-bg);box-shadow:0 0 0 3px var(--ac-light)}
.sf-select{width:100%;padding:11px 14px;border:2px solid var(--input-border);border-radius:10px;font-size:14px;color:var(--text);background:var(--input-bg-alt);transition:all .2s;outline:none;cursor:pointer;appearance:auto}
.sf-select:focus{border-color:var(--ac);background:var(--input-bg);box-shadow:0 0 0 3px var(--ac-light)}
.sf-select.err{border-color:#e53e3e}
.sf-pills{display:flex;flex-wrap:wrap;gap:8px}
.sf-pill{padding:8px 16px;border-radius:20px;border:2px solid var(--border);background:var(--card-bg);font-size:13px;font-weight:600;color:var(--text-3);cursor:pointer;transition:all .18s;display:flex;align-items:center;gap:6px}
.sf-pill:hover{border-color:var(--ac);color:var(--ac);background:var(--ac-light)}
.sf-pill.active{border-color:var(--ac);background:var(--ac);color:#fff;box-shadow:var(--glow-sm)}
...
.sf-num{width:100%;padding:11px 14px;border:2px solid var(--input-border);border-radius:10px;font-size:18px;font-weight:700;color:var(--text);background:var(--input-bg-alt);text-align:center;transition:all .2s;outline:none}
.sf-num:focus{border-color:var(--ac);background:var(--input-bg);box-shadow:0 0 0 3px var(--ac-light)}
.sf-mat-checks{display:flex;flex-wrap:wrap;gap:10px}
.sf-mat-chip{display:flex;align-items:center;gap:6px;padding:7px 12px;border:2px solid var(--border);border-radius:20px;cursor:pointer;font-size:12px;font-weight:600;color:var(--text-3);background:var(--card-bg);transition:all .15s;user-select:none}
.sf-mat-chip.checked{border-color:var(--ac);background:var(--ac-light);color:var(--ac);box-shadow:var(--glow-sm)}
.sf-mat-chip input{display:none}
.sf-err{color:#f87171;font-size:11px;font-weight:600;margin-top:4px;display:block}
.sf-title{font-size:18px;font-weight:800;color:var(--text);margin-bottom:2px}
.sf-subtitle{font-size:12px;color:var(--text-muted);margin-bottom:16px}
.sf-btn-primary{padding:13px 28px;border:none;border-radius:12px;cursor:pointer;font-size:14px;font-weight:700;color:#fff;background:var(--ac);transition:filter .2s;display:flex;align-items:center;gap:8px;box-shadow:var(--glow-sm)}
.sf-btn-primary:hover:not(:disabled){filter:brightness(1.1);box-shadow:var(--glow)}
.sf-btn-primary:disabled{opacity:.6;cursor:not-allowed;box-shadow:none}
.sf-btn-secondary{padding:13px 24px;border:2px solid var(--border);border-radius:12px;cursor:pointer;font-size:14px;font-weight:600;color:var(--text-2);background:var(--card-bg);transition:all .2s}
.sf-btn-secondary:hover{border-color:var(--text-3);color:var(--text)}
.sf-conseiller-badge{display:inline-flex;align-items:center;gap:8px;padding:6px 14px;border-radius:20px;font-size:12px;font-weight:700;color:#fff;background:var(--ac);margin-bottom:14px;box-shadow:var(--glow-sm)}
/* ── v9.2 : Calendrier ── */
.cal-grid{display:grid;grid-template-columns:repeat(5,1fr);gap:3px;margin-bottom:3px}
.cal-header-cell{text-align:center;font-size:11px;font-weight:700;color:var(--text-3);padding:6px 2px;text-transform:uppercase;letter-spacing:.06em;background:var(--surface);border-radius:4px}
.cal-cell{min-height:88px;padding:5px;border-radius:6px;border:1px solid var(--border);background:var(--card-bg);transition:background .12s;vertical-align:top;overflow:hidden}
.cal-cell:hover{background:var(--surface)}
.cal-cell-empty{background:var(--surface-alt);border-color:var(--border-light);cursor:default}
.cal-today{background:var(--accent-bg);border-color:var(--accent);box-shadow:var(--glow-sm)}
.cal-today:hover{background:var(--accent-bg)}
.cal-day-num{font-size:12px;font-weight:600;color:var(--text-2);margin-bottom:3px;line-height:1.4}
.cal-today-num{display:inline-flex;align-items:center;justify-content:center;width:20px;height:20px;background:var(--accent);color:#fff;border-radius:50%;font-size:11px;font-weight:700;box-shadow:var(--glow-sm)}
...
.cal-more{font-size:9.5px;color:var(--text-muted);cursor:pointer;margin-top:2px;font-weight:600;padding:1px 4px;background:var(--surface-2);border-radius:3px;display:inline-block}
.cal-more:hover{color:var(--accent-2);background:var(--accent-bg)}
...
.cal-year-sel option{background:var(--accent);color:#fff}
...
.theme-select-bars{display:flex;align-items:flex-end;gap:3px;width:100%;height:100%}
.theme-select-bar{flex:1;border-radius:2px 2px 0 0;min-height:3px}
.theme-select-info{display:flex;align-items:center;gap:10px;padding:10px 12px}
.theme-select-ico{font-size:18px;flex-shrink:0}
...
/* ── Picker thème (topbar) ── */
.theme-picker-overlay{position:fixed;inset:0;z-index:9997}
...
.theme-picker-btn.active{background:var(--accent-bg)}
.theme-picker-ico{font-size:18px;flex-shrink:0}
.theme-picker-lbl{font-size:13px;font-weight:700;color:var(--text);display:block;line-height:1.2}
.theme-picker-desc{font-size:10px;color:var(--text-3);display:block;margin-top:1px}
`;
  ...
  return CE('div',null,
    ...
    CE('div',{className:'card',style:{marginBottom:10}},
      ...
      CE('div',{style:{display:'flex',gap:8,flexWrap:'wrap',alignItems:'center'}},
        CE('input',{type:'text',value:search,placeholder:'🔍 Recherche…',style:{flex:'1 1 160px',padding:'6px 10px',border:'1.5px solid var(--border,#e2e8f0)',borderRadius:6,fontSize:13,background:'var(--input-bg,#fff)',color:'var(--text,#1a202c)'},onChange:e=>setSearch(e.target.value)}),
        CE('select',{style:{padding:'6px 8px',border:'1.5px solid var(--border,#e2e8f0)',borderRadius:6,fontSize:12,background:'var(--input-bg,#fff)',color:'var(--text,#1a202c)'},value:filtMois,onChange:e=>setFiltMois(e.target.value)},
          CE('option',{value:'Tous'},'Tous les mois'),moisDispo.map(m=>CE('option',{key:m,value:m},m))),
        CE('select',{style:{padding:'6px 8px',border:'1.5px solid var(--border,#e2e8f0)',borderRadius:6,fontSize:12,background:'var(--input-bg,#fff)',color:'var(--text,#1a202c)'},value:filtCommune,onChange:e=>setFiltCommune(e.target.value)},
          CE('option',{value:'Toutes'},'Toutes communes'),COMMUNES.map(c=>CE('option',{key:c,value:c},c))),
        CE('select',{style:{padding:'6px 8px',border:'1.5px solid var(--border,#e2e8f0)',borderRadius:6,fontSize:12,background:'var(--input-bg,#fff)',color:'var(--text,#1a202c)'},value:filtConseiller,onChange:e=>{setFiltConseiller(e.target.value);if(onChangeConseiller)onChangeConseiller(e.target.value);}},
      ...
      CE('div',{style:{display:'flex',gap:8,flexWrap:'wrap',alignItems:'center',marginTop:8}},
        CE('div',{style:{display:'flex',alignItems:'center',gap:4}},
          ...
          CE('input',{type:'date',value:dateFrom,onChange:e=>setDateFrom(e.target.value),style:{padding:'6px 8px',border:'1.5px solid var(--border,#e2e8f0)',borderRadius:6,fontSize:12,background:'var(--input-bg,#fff)',color:'var(--text,#1a202c)'}}),
          CE('span',{style:{fontSize:11,fontWeight:700,color:'#718096',whiteSpace:'nowrap'}},'Au'),
          CE('input',{type:'date',value:dateTo,onChange:e=>setDateTo(e.target.value),style:{padding:'6px 8px',border:'1.5px solid var(--border,#e2e8f0)',borderRadius:6,fontSize:12,background:'var(--input-bg,#fff)',color:'var(--text,#1a202c)'}})
        ),
    ...
    CE('div',{className:'side-panel'+(panel?' open':'')},
      panel&&CE(React.Fragment,null,
        ...
        CE('div',{className:'side-panel-body'},
          ...
          CE('div',{style:{fontSize:13,fontWeight:700,color:'var(--text,#1a202c)',marginBottom:8}},panel.thematique),
          ...
          CE('div',{className:'sp-field'},CE('label',null,'Statut *'),
            CE('select',{value:panelStatut,onChange:e=>setPanelStatut(e.target.value),style:{width:'100%',padding:'8px 10px',border:'1.5px solid var(--border,#e2e8f0)',borderRadius:6,fontSize:13,background:'var(--input-bg,#fff)',color:'var(--text,#1a202c)'}},
              STATUTS.map(s=>CE('option',{key:s,value:s},s)))),
          CE('div',{className:'sp-field'},CE('label',null,"Nombre d'inscrits"),
            CE('input',{type:'number',min:0,value:panelInscrits,onChange:e=>setPanelInscrits(e.target.value),style:{width:'100%',padding:'8px 10px',border:'1.5px solid var(--border,#e2e8f0)',borderRadius:6,fontSize:13,background:'var(--input-bg,#fff)',color:'var(--text,#1a202c)'},placeholder:'0'})),
          CE('div',{className:'sp-field'},CE('label',null,'Nombre de présents'),
            CE('input',{type:'number',min:0,value:panelPresents,onChange:e=>setPanelPresents(e.target.value),style:{width:'100%',padding:'8px 10px',border:'1.5px solid var(--border,#e2e8f0)',borderRadius:6,fontSize:13,background:'var(--input-bg,#fff)',color:'var(--text,#1a202c)'},placeholder:'0'})),
          CE('div',{className:'sp-field'},CE('label',null,'Remarques'),
            CE('textarea',{value:panelNote,onChange:e=>setPanelNote(e.target.value),rows:3,placeholder:'Ajouter une note…',style:{width:'100%',padding:'8px 10px',border:'1.5px solid var(--border,#e2e8f0)',borderRadius:6,fontSize:13,resize:'vertical',background:'var(--input-bg,#fff)',color:'var(--text,#1a202c)'}}))
        ),
    ...
    CE('div',{className:'card',style:{marginBottom:12}},
      CE('div',{style:{display:'flex',alignItems:'center',justifyContent:'space-between',flexWrap:'wrap',gap:10,marginBottom:12}},
        ...
        CE('div',{style:{display:'flex',alignItems:'center',gap:8}},
          ...
          CE('select',{value:filtConseiller,onChange:e=>{setFiltConseiller(e.target.value);if(onChangeConseiller)onChangeConseiller(e.target.value);},style:{padding:'5px 10px',border:'1.5px solid var(--border,#e2e8f0)',borderRadius:6,fontSize:13,background:'var(--input-bg,#fff)',color:'var(--text,#1a202c)'}},
    ...
    CE('div',{className:'card',style:{marginBottom:12}},
      CE('div',{style:{display:'flex',alignItems:'center',gap:10,flexWrap:'wrap'}},
        ...
        CE('div',{style:{display:'flex',alignItems:'center',gap:6,marginLeft:4}},
          ...
          CE('input',{type:'date',value:dateFrom,onChange:e=>setDateFrom(e.target.value),style:{padding:'5px 8px',border:'1.5px solid var(--border,#e2e8f0)',borderRadius:6,fontSize:12,background:'var(--input-bg,#fff)',color:'var(--text,#1a202c)'}}),
          CE('span',{style:{fontSize:12,color:'#718096'}},'Au'),
          CE('input',{type:'date',value:dateTo,onChange:e=>setDateTo(e.target.value),style:{padding:'5px 8px',border:'1.5px solid var(--border,#e2e8f0)',borderRadius:6,fontSize:12,background:'var(--input-bg,#fff)',color:'var(--text,#1a202c)'}})
        ),
    ...
    CE('div',{className:'admin-section'},
      ...
      CE('div',{style:{display:'flex',flexDirection:'column',gap:10}},
        (conseillersList||Object.keys(CONSEILLER_COLORS)).map(c=>{
          ...
          return CE('div',{key:c,style:{display:'flex',alignItems:'center',gap:12,padding:'10px 14px',background:'var(--surface,#f8fafc)',borderRadius:10,border:'1.5px solid var(--border,#e2e8f0)'}},
            // Color picker visuel
            ...
            // Nom
            CE('span',{style:{flex:1,fontWeight:700,fontSize:14,color:'var(--text,#1a202c)'}},c),
            // Input hex éditable
            CE('input',{type:'text',value:hexVal,maxLength:7,
              ...
              style:{width:88,fontFamily:'monospace',fontSize:13,fontWeight:700,color:'var(--text,#1a202c)',padding:'6px 10px',border:'1.5px solid var(--border,#e2e8f0)',borderRadius:8,background:'var(--input-bg,#fff)',textAlign:'center'}}),
            // Bouton reset
